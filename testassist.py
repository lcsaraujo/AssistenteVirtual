...
def takeCommand():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print(e)
            print("Eu não entendi, pode repetir por favor ?")
            return "None"
...
def Hello():
    ...
    # take query
    speak("Olá, sou a Kira Assistente, como posso te ajudar hoje? ")
...
def Take_query():
    ...
    while (True):
        ...
        elif "qual o seu nome" in query:
            speak("Sou a Kira. Sua assistente virtual")
